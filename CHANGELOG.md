...
* **cli:** add import-light environment capability diagnostics to `headroom doctor`, including Python/runtime support, native `headroom._core` status, optional extra availability, exact install hints, and runnable CLI surface summaries in JSON and human output ([#842](https://github.com/chopratejas/headroom/issues/842)).
