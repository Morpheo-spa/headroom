...
def test_npm_release_builder_regenerates_openclaw_dist_metadata_after_rewrite() -> None:
    ...
    pack = builder.index('runNpm(["pack", "--pack-destination", assetsDir], openClawDir);', prepare_dist)
    verify = builder.index('runNode(["scripts/verify_npm_release_assets.mjs", assetsDir, version], rootDir)', pack)
